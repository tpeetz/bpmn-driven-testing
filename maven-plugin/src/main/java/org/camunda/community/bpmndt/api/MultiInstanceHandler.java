 ...
 * sub process multi instances like sub processes or transactions.
 *
...
public class MultiInstanceHandler<T extends MultiInstanceHandler<?, ?>, U> {
   ...
   */
  protected JobHandler createJobHandlerAfter(int loopIndex) {
   ...
   * @return The newly created job handler.
   */
  protected JobHandler createJobHandlerBefore(int loopIndex) {
